...
async def list_quizzes(db: AsyncSession = Depends(get_session), current_user = Depends(get_current_user)):
...
async def list_published_quizzes(db: AsyncSession = Depends(get_session), current_user = Depends(get_current_user)):
...
async def get_quiz(quiz_id: UUID, db: AsyncSession = Depends(get_session), current_user = Depends(get_current_user)):
...
async def list_quiz_questions(quiz_id: UUID, db: AsyncSession = Depends(get_session), current_user = Depends(get_current_user)):
    from app.db.models import QuizQuestion, Question
...
async def list_quiz_versions(quiz_id: UUID, db: AsyncSession = Depends(get_session), current_user = Depends(get_current_user)):
